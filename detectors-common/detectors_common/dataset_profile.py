...
that this package's detection-parameter derivation (box_size, nms_distance,
tile_size) derives from -- see dataset-profiles/README.md for the file
format and the derivation rationale.

This loader is deliberately duplicated in trackers_common.dataset_profile
